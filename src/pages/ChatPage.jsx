...
const suggestions = [
  'Is Velachery flooded right now?',
  'Construction near Koyambedu?',
  'Best route from Anna Nagar to OMR?',
...
export default function ChatPage() {
  const [messages, setMessages] = useState([
    {
      from: 'bot',
      text: "Hello. I'm Pathbot — your city intelligence assistant. Ask me about road conditions, flood zones, or construction anywhere in Chennai.",
    ...
    <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 4 }}>
              ...
              <span style={{ fontSize: 12, color: '#475569' }}>Connected to live Chennai city data</span>
            </div>
          </div>
        </div>
        <div style={{
      ...
      <div style={{
        ...
        {messages.length === 1 && (
          <div style={{
            ...
            <p style={{ fontSize: 11, fontWeight: 700, color: '#7c3aed', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 12 }}>
        ...
        <div style={{ padding: '0 32px 16px', display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          {suggestions.map((s, i) => (
            <button key={i} onClick={() => sendMessage(s)} style={{
              background: 'rgba(124,58,237,0.08)', border: '1px solid rgba(124,58,237,0.2)',
              color: '#a78bfa', padding: '9px 16px', borderRadius: 20,
      ...
      <div style={{
        ...
        <input
          ...
          placeholder="Ask about any road, area, or disruption in Chennai…"
          style={{
